  ...
  <tr>
    ...
    <td class="listrnobg" style="border-bottom: 0;">
      <table><tr>
        ...
        <td width="225px" style="text-align:right">
          <img src="images/icon_help.gif" width="24px" title="<?=htmlspecialchars($l['option1tip']);?>">
        </td>
      </tr></table>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="listrnobg" style="border-bottom: 0;">
      <table><tr>
        ...
        <td width="225px" style="text-align:right">
          <img src="images/icon_help.gif" width="24px" title="<?=htmlspecialchars($l['option2tip']);?>">
        </td>
      </tr></table>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="listrnobg" style="border-bottom: 0;">
      <table><tr>
        ...
        <td width="225px" style="text-align:right">
          <img src="images/icon_help.gif" width="24px" title="<?=htmlspecialchars($l['option3tip']);?>">
        </td>
      </tr></table>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="listrnobg" style="border-bottom: 0;">
      <table><tr>
        ...
        <td width="225px" style="text-align:right">
          <img src="images/icon_help.gif" width="24px" title="<?=htmlspecialchars($l['option4tip']);?>">
        </td>
      </tr></table>
    </td>
  </tr>
    ...
    <td class="listrnobg" style="border-bottom: 0;">
      <table><tr>
        ...
        <td width="75px" style="text-align:right">
          <img src="images/icon_help.gif" width="24px" title="<?=htmlspecialchars($l['option5tip']);?>">
        </td>
      </tr></table>
    </td>
  </tr>
